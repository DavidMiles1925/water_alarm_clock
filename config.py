ALARM_HOUR = 5         #   These two variables determine default alarm time.
ALARM_MINUTE = 0       #       ALARM_HOUR:ALARM_MINUTE
                        #       Set to an integer between 0 and 59

ALARM_SET = True        #   Alarm on/off by default.
...
SNOOZE_COUNT_CONFIG = 1     #   SNOOZE_COUNT_CONFIG = 1: Pump will activate once more 
                            #       in addition to intial alarm. The number of seconds
                            #       between the intial alarm and the snooze alarm 
...
MAX_SNOOZE_TIME = 30        #   The time in seconds between the intial alarm and the
                            #       snooze alarm when SNOOZE_COUNT_CONFIG = 1

BYPASS_SET_TIME = False     #   This variable is used to bypass setting the time on power-up
                            #       False:  User will set system time manually
                            #       True:   System time will be set to default

BYPASS_INSTRUCTIONS = False #   This variable is used to bypass set-time instructions
